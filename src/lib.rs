...
mod tests {
  ...
  fn test_vectors() {
    ...
    let encipher15="EncipherMessage".as_bytes();
    ...
    test_vector(&linear_wring,&encipher15,
       &[ 0xc5, 0x0e, 0xc1, 0x88, 0xfd, 0x97, 0x89, 0x2d
    ...
    test_vector(&empty_wring,&encipher15,
    ...
    test_vector(&aerate_wring,&encipher15,
    ...
    test_vector(&χαίρετε_wring,&encipher15,
    ...
    test_vector(&двор_wring,&encipher15,
